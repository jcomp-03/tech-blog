...
CREATE TABLE blog_post (
    ...
    CONSTRAINT fk_BLOG_POST_user_id FOREIGN KEY (user_id) REFERENCES user(id) ON DELETE CASCADE
);
...
CREATE TABLE comment (
    ...
    CONSTRAINT fk_COMMENT_post_id FOREIGN KEY (post_id) REFERENCES blog_post(id) ON DELETE SET NULL
);
...
INSERT INTO blog_post (title, content, user_id, referred_article)
VALUES
('Cogito, ergo sum',
